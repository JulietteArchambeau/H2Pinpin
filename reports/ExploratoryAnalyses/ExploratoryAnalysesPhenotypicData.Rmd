...
```{r BDX2013HeightOLD, fig.height=10,fig.width=12,warning=F,message=F,eval=F}
...
p
ggsave(p,file="figs/ExploratoryAnalyses/HeightPierroton2013_EMTgradient.png",height=height.wrap,width=width.wrap)
```
...
p
ggsave(p,file="figs/ExploratoryAnalyses/HeightPierroton2018_EMTgradient.png",height=height.wrap,width=width.wrap)
```
...
p
ggsave(p,file="figs/ExploratoryAnalyses/BudBurstPierroton2014_EMTgradient.png",height=height.wrap,width=width.wrap)
```
...
p
ggsave(p,file="figs/ExploratoryAnalyses/DurationBudBurstPierroton2014_EMTgradient.png",
...
tab %>% 
  kable(digits=2,caption="Table SX of the paper",escape = FALSE) %>%
  kable_styling(latex_options =c("striped", "hold_position")) %>%
