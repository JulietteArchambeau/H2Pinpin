...
ggplot(data, aes(x= log(POR_SLA))) + 
  ...
  theme_bw() + 
  labs(x=TeX("Surface Leaf Area (Fundão, m$^{2}$/kg)"),y=""),
...
tibble(Traits=c(rep("Height",4),"Mean bud burst date", "Mean duration of bud burst","Surface Leaf Area","$\\delta^{13}$C"),
       ...
       "Common gardens"=c("Fundão","Cabada",rep("Pierroton",4),rep("Fundão",2)),
       
       "Dates of measurement" =c("October 2012","November 2012","November 2013", "November 2018", "2013, 2014, 2015, 2017", "2014, 2015 2017", NA,NA),
