...
Sum-up of the traits selected in this study:
  ...
  - Height:
      ...
      - In Bordeaux (France):  height in November 2013 when the trees were 25 month old & in November 2018 when the trees were 85 month old.
    
  - Phenology:
      
      - bud burst (=date of brachybalst emergence) in 2014 in Bordeaux
      
      - duration of bud burst in 2014 in Bordeaux.
...
tibble(Traits=c(rep("Height",4),"Mean bud burst date", "Mean duration of bud burst","Surface Leaf Area","$\\delta^{13}$C"),
       ...
       "Common gardens"=c("Fundão",rep("Bordeaux",2),"Cabada",rep("Bordeaux",2),rep("Fundão",2)),
