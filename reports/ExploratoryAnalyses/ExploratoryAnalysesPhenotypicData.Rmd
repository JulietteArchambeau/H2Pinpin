...
```{r AST2012HeightMCMT, fig.height=10,fig.width=12,warning=F,message=F}
# Per provenance
# --------------
...
```{r POR2012HeightMCMT, fig.height=10,fig.width=12,warning=F,message=F}
# Per provenance
# --------------
...
```{r BDX2014BBMCMT, fig.height=10,fig.width=12,warning=F,message=F}
# Per provenance
# --------------
...
p
ggsave(p,file="figs/ExploratoryAnalyses/BudBurstBordeaux2014_MCMTgradient.png",height=height.wrap,width=width.wrap)
```
...
```{r BDX2014DBBMCMT, fig.height=10,fig.width=12,warning=F,message=F}
# Per provenance
# --------------
...
```{r PORd13CMCMT, fig.height=10,fig.width=12,warning=F,message=F}
# Per provenance
# --------------
...
```{r PORSLAMCMT, fig.height=10,fig.width=12,warning=F,message=F}
# Per provenance
# --------------
