...
if(sub=="sub2"){traits <- c("AST_htnov12","BDX_htnov13","BDX_htnov18","MeanBB","MeanDBB")} else {
...
if(sub=="sub2"){
  ...
  trait.shapes <- c(16,16,16,17, 17)
  width.png.selected.drivers=10} else {
...
sub="alldata" # this part was only one on the unfiltered dataset
traits <- c("POR_htoct12","AST_htnov12","BDX_htnov13","BDX_htnov18","MeanBB","MeanDBB","POR_SLA","d13C")
drivers <- c("A","D","EH1[20km]","EH2[20km]","EH1[1.6km]","EH2[1.6km]","SHM","invEMT")    
param <- "betaX"
...
```{r RsquaredPosteriors,eval=T}
for(sub in c("alldata","sub1","sub2")){
