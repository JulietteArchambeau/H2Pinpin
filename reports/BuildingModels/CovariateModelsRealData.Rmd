...
trait <- "BDX_htnov13" # Bordeaux (France) - November 2013
trait <- "BDX_htnov18" # Bordeaux (France) - November 2018 
...
### Main figure of the paper (Figure 2)
...
p <- df %>% 
  ...
  theme(axis.text.x = element_text(size=13),
      ...
      panel.grid.minor.x=element_blank(),
      panel.grid.major.x=element_blank()) +
    guides(color=guide_legend(ncol=2,reverse=T))
