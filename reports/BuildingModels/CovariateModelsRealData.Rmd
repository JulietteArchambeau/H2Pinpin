...
where $Var_{\mu}$ is the fitted variance, i.e. the variance of the modelled predicted means and  $Var_y$ is the total variance, i.e. the variance of the observations. 
...
where $Var_{res}$ is the residual variance, which can be obtained with two different ways.
...
if(sub=="sub1"){
  ggsave(p, file="figs/PosteriorDistributions/ALLTRAITS_Alldrivers_BetaX_SI_sub1.png",height=8,width=12)} else if (sub=="sub2"){
  ggsave(p, file="figs/PosteriorDistributions/ALLTRAITS_Alldrivers_BetaX_SI_sub2.png",height=8,width=10)} else {
  ggsave(p, file="figs/PosteriorDistributions/ALLTRAITS_Alldrivers_BetaX_SI.png",height=8,width=12)  
  }
```
...
```{r ScatterplotsSigmaClonAgainstXp}
traits <- c("POR_htoct12","BDX_htnov13","BDX_htnov18","AST_htnov12","MeanBB","MeanDBB","POR_SLA","d13C")
