...
# We rename PRCsum to MSP (to have the same variable names in the paper)
tab <- tab %>% dplyr::rename(MSP=PRCsum)
...
MSP_height_bordeaux85 <- mean(df.site[df.site$Year %in% 2012:2018 & df.site$ID=="bordeaux","MSP"]) # mean from 2011 to 2018
