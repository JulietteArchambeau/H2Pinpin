...
```{r CreateColumnsCTD}
df <- df %>% 
  dplyr::mutate(CTD_asturias_EMT=(invEMT+df.site[df.site$site=="asturias","EMT_site"] %>% pull()) %>% abs(),
                CTD_asturias_SHM=(SHM-df.site[df.site$site=="asturias","SHM_site"] %>% pull()) %>% abs(),
                CTD_bordeaux_EMT=(invEMT+df.site[df.site$site=="bordeaux","EMT_site"] %>% pull()) %>% abs(),
                CTD_bordeaux_SHM=(SHM-df.site[df.site$site=="bordeaux","SHM_site"] %>% pull()) %>% abs(),
                CTD_portugal_EMT=(invEMT+df.site[df.site$site=="portugal","EMT_site"] %>% pull()) %>% abs(),
