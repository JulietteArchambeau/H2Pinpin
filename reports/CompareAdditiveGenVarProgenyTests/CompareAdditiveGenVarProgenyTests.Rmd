...
if (trait=="HT10"){
 ...
 x.label.histogram= "Height measured in the progeny test of Asturias 10 2010"
 x.legend = 0.386
}
...
ggsave(p,file=paste0("figs/PosteriorDistributions/",x,"_SigmaClon_ProgenyTestsAsturias.png"),height=6,width=22)
...
ggsave(p,file=paste0("figs/PosteriorDistributions/",x,"_h2prov_ProgenyTestsAsturias.png"),height=6,width=22)
...
ggsave(p,file=paste0("figs/PosteriorDistributions/",x,"_VarPart_ProgenyTestsAsturias.png"),height=6,width=18)
